...
- **Интерактивное подтверждение**: Запрос при существующей папке результатов
...
5. **Обработка исключений**: Try-except блоки с информативными сообщениями об ошибках
